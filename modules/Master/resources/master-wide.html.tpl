...
{*may not be needed*}       <meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <link rel="stylesheet" type="text/css" href="assets/less/master-wide.less.css?cache=2019010700">
            ...
            <nav class="navbar navbar navbar-static-top" role="navigation">
              <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    {if $pAdmin}
                    <li>
                        <a class="manage-link btn btn-link" href="admin"><i class="halflings-icon white cog"></i> Administrate</a>
                    </li>
                    {/if}                    
                    <li>
      ...
      <div class="footer">
        <div class="container">
          <div id="footer-row" class="row">
            <div id="contact-university" class="col-sm-8">
        ...
        <script src="assets/js/app.js?modified=2019010700"></script>
    </body>
</html>
