...
/**
 * Workstation Selection application error handler for errors that
 ...
 */
class Classrooms_Master_FallbackErrorHandler extends Classrooms_Master_ErrorHandler
{
    public static function getErrorClassList () { return [ Bss_Routing_ErrorManager::UNHANDLED_ERROR_CLASS ]; }
