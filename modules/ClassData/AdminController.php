...
/**
 */
class Classrooms_ClassData_AdminController extends At_Admin_Controller
{
    ...
    public function import ()
    {
        if ($this->request->wasPostedByUser())
        {
            ...
            {
                $rs = pg_query("
                    SELECT u.id FROM classroom_classdata_users u, bss_authn_accounts a 
    ...
    public function editDepartment ()
    {
        ...
        $department = $this->helper('activeRecord')->fromRoute('Classrooms_Department_Department', 'id', ['allowNew' => true]);
    ...
    public function sectionInfo ()
    {
        ...
        if ($this->request->wasPostedByUser())
        {
            ...
            {
                $department = $this->schema('Classrooms_Department_Department')->get($departmentId);
    ...
    public function userInfo ()
    {
        ...
        $this->template->academicGroups = $this->schema('Classrooms_AcademicOrganizations_College')->getAll(['orderBy' => 'name']);
    }
