...
/**
 */
class Classrooms_ClassData_ModuleUpgradeHandler extends Bss_ActiveRecord_BaseModuleUpgradeHandler
{
    public function onModuleUpgrade ($fromVersion)
    {
        ...
        switch ($fromVersion)
        {
            case 0:
                ...
                $def = $this->createEntityType('classroom_classdata_courses', $this->getDataSource('Classrooms_ClassData_Course'));
                ...
                $def = $this->createEntityType('classroom_classdata_course_sections', $this->getDataSource('Classrooms_ClassData_CourseSection'));
                $def->addProperty('id', 'string', ['primaryKey' => true, 'sequence' => true]);
                ...
                $def->addProperty('classroom_id', 'int');
                $def->addProperty('department_id', 'int');
                $def->addIndex('course_id');
                $def->save();

                $def = $this->createEntityType('classroom_classdata_users', $this->getDataSource('Classrooms_ClassData_User'));
                $def->addProperty('id', 'string', ['primaryKey' => true, 'sequence' => true]);
                ...
                $def = $this->createEntityType('classroom_classdata_enrollments', $this->getDataSource('Classrooms_ClassData_Enrollment'));
