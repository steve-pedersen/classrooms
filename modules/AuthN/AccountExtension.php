 ...
 */
class Classrooms_AuthN_AccountExtension extends Bss_AuthN_AccountExtension implements Bss_AuthN_IAccountSettingsExtension
{
    ...
    {
        $roles = $handler->schema('Classrooms_AuthN_Role');
